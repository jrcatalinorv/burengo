...
<div class="wrapper">
  ...
  <!-- Right navbar links -->
	...
	<li class="nav-item dropdown" data-toggle="modal" data-target="#catcurrency"><a class="nav-link"  href="#"><i class="fas fa-plus-circle"></i>  Provincias  </a></li>
    </ul>
  </nav>
  <!-- /.navbar -->
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				 ...
				 <div class="input-group mb-3">
                  ...
                  <input id="modalNewCategory" type="text" class="form-control" placeholder="Digite el nombre de la provincia" >
                </div>					 
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button id="modalSave" type="button" class="btn btn-success"> <i class="fas fa-save"></i> Guardar </button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
$('#modalSave').click(function(){
	$.getJSON('ajax/burengo_insert_place.php',{
		code: 'do',
		place: $('#modalNewCategory').val()
	},function(data){
		switch(data['ok']){
